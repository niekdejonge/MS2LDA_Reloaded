...
def select_smiles_for_mass2motifs(raw_library_spectra_file, motif_set_name, bin_size):
    ...
    selected_smiles = spectra_selector.select_spectra_matching_mass2motif(0.1)
...
if __name__ == "__main__":
    ...
    print(json_mass_2motif_set.keys())
    # # search mass2motif
    ...
    # spectra_selector: SelectSpectraContainingMass2Motif = load_pickled_file("../data/select_spectra_containing_mass2motifs.pickle")
    # spectra_selector.create_all_moss_files("../data/moss/", 0.1)
